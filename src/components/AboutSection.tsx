    ...
    <div className="absolute left-[40%] -top-4 md:-left-20  lg:top-0 md:top-4 rotate-0 md:rotate-[-90deg] text-sm tracking-widest">
      <div className="flex items-center justify-center gap-1">
        ...
        <p className="text-gray-300 mb-6 text-sm md:text-base leading-relaxed max-w-2xl mx-auto md:mx-0 mt-5">
          Future Smile Care is a leading organization dedicated to smart metering solutions and
          electrical infrastructure development. We are committed to delivering innovative and
          sustainable energy management services that empower communities and drive progress.
        </p>
